...
class Data extends CI_Controller {
    ...
    function form()
	{
		...
		$fieldset = array(
			...
			array(
				...
				'class'=>'',
				'icon'=>'',
				'custom_attributes'=>array("value"=>"3")
			),
			array(
				'name'=>'Action',
				'type'=>'hidden',
	...
	function view($id)
	{
		...
		$fieldset = array(
			...
			array(
				...
				'options'=>$groups,
				'default_options'=>$view_data->group_id
			),
			array(
				'name'=>'Action',
				'type'=>'hidden',
	...
	function list()
    {
		...
		$column_order = array(null, 'username','email','fullname','phone','role_id','created_at'); //field yang ada di table user
		$column_search = array('username','email','fullname','phone','role_id','created_at'); //field yang diizin untuk pencarian 
