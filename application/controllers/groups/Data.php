...
class Data extends CI_Controller {
    ...
    function form()
	{
		...
		$fieldset = array(
			...
			array(
				...
				'class'=>'',
				'icon'=>'fa-user',
				'custom_attributes'=>array("placeholder"=>"Group Name")
			),
			array(
				'name'=>'Action',
				'type'=>'hidden',
	...
	function form_submit()
	{
		...
		if($action == "Update"){
			...
			if($this->db->get_where('groups',array('id'=>$data['id']))->num_rows()==0){
	...
	function list()
    {
		$table = 'groups'; //nama tabel dari database
